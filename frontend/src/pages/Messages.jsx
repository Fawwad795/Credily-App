    ...
    if (selectedChat) {
      try {
        ...
        if (response.data && response.data.success) {
          setMessages(response.data.data.messages.map(msg => ({
            id: msg._id,
              ...
              {chats.map((chat) => (
                ...
                >
                  <div className="relative">
                    ...
                    />
                    {onlineUsers.some(u => u.userId === chat.id || u.email === chat.email) && (
              ...
              <>
                ...
                <div className="p-4 bg-gray-50 text-gray-800 shadow-md">
                  <div className="flex items-center">
                    <img
                      src={selectedChat.profilePicture || "/default-profile.png"}
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        {onlineUsers.some(u => u.userId === selectedChat.id || u.email === selectedChat.email) 
                          ? "Online" 
                          : "Offline"}
                      </p>
                    </div>
