...
import SearchSlider from "./SearchPage"; // Import the SearchSlider component
import "./index.css";

const Nav = () => {
  const [isSearchOpen, setIsSearchOpen] = useState(false); // Controls the search slider visibility
  ...
  return (
    <>
         ...
         <Link to ="/profile">   <li>
            ...
            <li>
              ...
              >
                ...
                <span className="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-green-800 bg-green-200 rounded-full">
                  3
                </span>
              </Link>
            </li>
      ...
      <SearchSlider
        isOpen={isSearchOpen}
        onClose={() => setIsSearchOpen(false)} // Close the search slider
      />
    </>
  );
};
